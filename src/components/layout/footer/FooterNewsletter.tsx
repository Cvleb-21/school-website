    ...
    <div className="mt-8 xl:mt-0">
      ...
      <form className="mt-4 sm:flex sm:max-w-md" onSubmit={handleSubmit}>
        ...
        <input
          ...
          className="w-full min-w-0 px-4 py-2 text-base text-gray-900 placeholder-gray-500 bg-white border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white focus:border-white"
